        ...
        <div className="space-y-8">
          ...
          <div className="bg-white p-8 rounded-3xl shadow-sm border border-gray-100 flex items-start gap-6">
            ...
            <div>
              ...
              <a 
                href={`https://wa.me/${businessInfo.whatsapp.replace(/\s+/g, '')}`} 
          ...
          <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <input type="text" className="w-full border-2 border-gray-100 p-4 rounded-xl focus:border-blue-500 focus:outline-none" placeholder="John Doe" />
              </div>
              <div>
                <label className="block text-xs font-black text-gray-400 uppercase mb-2">Phone Number</label>
                <input type="text" className="w-full border-2 border-gray-100 p-4 rounded-xl focus:border-blue-500 focus:outline-none" placeholder="+92 3XX XXXXXXX" />
              </div>
            </div>
            <div>
              <label className="block text-xs font-black text-gray-400 uppercase mb-2">Inquiry Type</label>
              <select className="w-full border-2 border-gray-100 p-4 rounded-xl focus:border-blue-500 focus:outline-none bg-white">
            ...
            <div>
              ...
              <textarea rows={4} className="w-full border-2 border-gray-100 p-4 rounded-xl focus:border-blue-500 focus:outline-none" placeholder="Tell us about your requirements..."></textarea>
            </div>
            <button className={`w-full bg-gradient-to-r ${themeColor} text-white py-5 rounded-xl font-black text-lg shadow-xl hover:scale-[1.02] transition-all`}>
              SEND INQUIRY
            </button>
          </form>
        </div>
